            ...
            $('#saveButton').html(`<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                ...
                $.ajax({
                    ...
                    error: function (data) { //jika error tampilkan error pada conso
                        ...
                        $('#error-name').html('<small id="emailHelp" class="form-text text-danger"><ion-icon name="alert-circle"></ion-icon> '+data.responseJSON.errors.name+'</span>');
                        $('#error-email').html('<small id="emailHelp" class="form-text text-danger"><div class="text-danger"><ion-icon name="alert-circle"></ion-icon> '+data.responseJSON.errors.email+'</span>');
                        $('#error-password').html('<small id="emailHelp" class="form-text text-danger"><ion-icon name="alert-circle"></ion-icon> '+data.responseJSON.errors.password+'</span>');
                    }
                });
            });
